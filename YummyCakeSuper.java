...
class CheeseCake extends Cake{
	...
	public void showCakeSize() {
		//super.size는 상위 클래스의 맴버 size를 의미함
		System.out.println("Bread Ounces:"+super.size);
		//size는 이 클래스 CheeseCake의 맴버 size를 의미함
...
public class YummyCakeSize {
	...
	//ca2는 Cake형이므로 ca2.size는 cake의 맴버size를 의미함
	System.out.println("Bread Ounces:"+ca2.size);
	
	//ca1은 CheeseCake형이므로 ca1.size는 CheeseCake의 맴버size를 의미함
